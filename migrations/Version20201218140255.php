 ...
 */
final class Version20201218140255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DD0FA36845BA1CA3 ON wishes');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_DD0FA36845BA1CA3 ON wishes (id_list)');
    }
}
