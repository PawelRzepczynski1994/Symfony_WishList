...
class WishListController extends AbstractController{
    ...
    public function wishlistShare(Request $request,$code): Response
    {
        ...
        return $this->render('wishlist/wishlistshare.html.twig',[
            'ListWishes' => $ListWishes,
            'error' => $error,
            ]);
    }
    ...
    public function wishlistJoin(Request $request,$code){
        ...
        return $this->render('wishlist/wishlistsharejoin.html.twig',[
            'ViewList' => $ViewList,
        ]);
    }
  /**
    ...
    public function wishlistedit(Request $request,$id){
        ...
        if(!$ListWishes){
            ...
            return $this->render('wishlist/wishlist.html.twig',['ListWishes' => NULL]);
        }
        ...
        $ListWishess = $repository_2->findby(['id_list' => $id]);
            ...
            return $this->render('wishlist/wishlistedit.html.twig',[
      ...
      /**
     * @Route("/wishlist/add", name="wishlistadd",methods={"GET","HEAD"})
     */
    public function wishlistAdd(Request $request) : Response {
        ...
        return $this->render('wishlist/wishlistadd.html.twig',[
            'form' => $form->createView(),
        ]);
    }
    ...
    public function wishlistOpen(Request $request,ListWishes $id){
        ...
        return $this->render('wishlist/wishlistOpen.html.twig',
    [
        'NameList'  => $NameList,
        'DescList'  => $DescList,
        'Username'  => $Username,
